...
def getDataLoader(batch_size = 512):
    ...
    train_data = datasets.CIFAR10('../data', train=True, download=True, transform=getTrainTransforms())
    
    # Load the MNIST dataset for testing, apply transformations and download if not present
    test_data = datasets.CIFAR10('../data', train=False, download=True, transform=getTestTransforms())
